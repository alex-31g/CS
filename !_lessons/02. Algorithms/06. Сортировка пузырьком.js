/*
Сортировка пузырьком - алгоритм сортировки последовательности данных, суть которого в сравнении пары соседних элементов, и если они стоят в неправильном порядке, то их меняют местами.
