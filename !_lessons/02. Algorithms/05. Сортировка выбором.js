/*
Сортировка выбором - алгоритм сортировки последовательности чисел в массиве. 

АЛГОРИТМ:
1) Используя линейный поиск, находим минимальное значение
2) Найденный элемент меняется местами с первым элементом (если минимальное значение уже является первым элементом, то обмен не требуется)
3) Операции 1-2 повторяются до тех пор, пока все числа не будут полность отсортированы 
